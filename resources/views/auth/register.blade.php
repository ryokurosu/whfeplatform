                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="male" type="radio" name="gender" value="男" required><label for="male">Male</label>
                                <input id="female" type="radio" name="gender" value="女" required><label for="female">Female</label>
                            </div>
                        </div>
