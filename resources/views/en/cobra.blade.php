       ...
       <div class="panel-body">
        ...
        <div class="tab-content">
          <div id="tab1" class="tab-pane active">
            ...
            <p>Maximum stop loss: 180 pips</p>
            <p>Maximum drawdown: 22%</p>
            <p>Both houses: yes</p>
          ...
          <div id="tab2" class="tab-pane">
            ...
            <p>Margin: 200,000 yen</p>
            <p>Revenue: 177,455.88 yen</p>
            <p>Account balance: 377,455.88 yen</p>
            <p>Total return: 87.22%</p>
            <p>Annual rate of return: 43.61%</p>
            <p>Monthly rate of return: 3.96%</p>
          </div>
          <div id="tab3" class="tab-pane">
            <embed src="{{url('/backtest/cobra.pdf')}}" width="100%" height="375">
              <a href="{{url('/backtest/cobra.pdf')}}">Detail (PDF)</a>
            </div>
          </div>
